# 2025.01.23 TIL
### SQL 중급(계층 쿼리, 그룹함수)에 대한 개인 테스트, SQL 고급(인덱스)  
인덱스에 대해서 배웠습니다.  
MYSQL로만 이해하고 있던 개념들인데 Oracle과 생각보다 다르게 동작하는 내용이 많아서 흥미롭게 들었습니다.  
이전 시간에 배웠던 SQL 중급에 대해서 개인으로 경쟁하는 쿼리작성 시간을 가졌습니다.  
이전에 배운 내용들에 대해서 더 숙련될 수 있었던 좋은 경험이었습니다.  

아래는 오늘 작성한 문제들의 쿼리입니다.  
```MYSQL
